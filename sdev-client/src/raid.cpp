...
void hook::raid()
{
    // Raid 150 component: restores the 5-page raid UI and redirects all party
    // indexing/rendering paths to the selected raid page.
    ...
    uint8_t Raidtextcolor1[5]{ 0x68, 0xFF, 0xFF, 0xFF, 0xFF };
    util::write_memory((void*)0x53D5B5, Raidtextcolor1, 5);
    uint8_t Raidtextcolor2[5]{ 0x68, 0xFF, 0xFF, 0xFF, 0xFF };
